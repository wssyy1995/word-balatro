...
| 四字母连击 | `length_4` | whole_word | 单词 ≥4 字母 | mult ×1.5 |
...
| 对称之美 | `double_and_firstend` | whole_word | 单词首尾字母相同或含相邻重复字母 | 首尾相同倍率 +6，相邻重复倍率 +5 |
...
**女巫牌列表**：元音强化、四字母连击、五字母连击、六字母连击、容错咒文、字母之神、生命延续、勇敢试错、以小博大、对称之美。
