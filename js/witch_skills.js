...
const WITCH_SKILLS = [
  ...
  { level: 11, name: '女巫 Lv.11', reward: 'card_random_upgrade',rate:0.3,reward_desc: '有概率获得一张: 随机强化' },
  { level: 14, name: '女巫 Lv.14', reward: 'global_witch_card_1',rate:1,reward_desc: '本赛局，增加一张女巫牌槽位'},
