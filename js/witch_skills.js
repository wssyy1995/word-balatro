...
const WITCH_SKILLS = [
  { level: 2, name: '女巫 Lv.2', skill: 'force_letter_3', reward: 'card_change_letter',rate:0.5,reward_desc: '有概率获得一张: 字母置换', desc: '每次出牌只能出3张字母牌' },
  ...
  { level: 8, name: '女巫 Lv.8', skill: 'forbid_illegal_words', reward: 'double_coin',rate:0.5,reward_desc: '有概率，已拥有金币翻倍', desc: '出现非法单词，游戏结束' },
