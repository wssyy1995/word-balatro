...
const WITCH_SKILLS = [
  ...
  { level: 5, name: '女巫_B', reward: 'global_letter_1',rate:1, has_reward: true, reward_desc: '本赛局,字母手牌+1' },
  { level: 8, name: '女巫_C',  reward: 'global_witch_card_1',rate:1, has_reward: true, reward_desc: '本赛局，增加一张女巫牌槽位'},
  { level: 11, name: '女巫_D', reward: 'shop_discount_5',rate:1, has_reward: true, reward_desc: '本回合卡牌商店，打5折'},
  { level: 14, name: '女巫_E', reward: 'double_coin',rate:0.5, has_reward: true, reward_desc: '有概率，已拥有金币翻倍' },
  { level: 16, name: '女巫_F', reward: 'card_random_upgrade',rate:1, has_reward: true, reward_desc: '有概率获得一张: 随机强化'},
  { level: 18, name: '女巫_G', reward: 'global_hand_1',rate:1, has_reward: true, reward_desc: '本赛局,出牌次数 +1'  },
  { level: 21, name: '女巫_H',  reward: 'card_upgrade_letter',rate:0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 24, name: '女巫_I',  reward: 'shop_discount_5',rate:1, has_reward: true, reward_desc: '本回合卡牌商店，打5折' },
  { level: 27, name: '女巫_J',  reward: 'card_upgrade_letter',rate:0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 29, name: '女巫_K', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 32, name: '女巫_L', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 35, name: '女巫_M', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 38, name: '女巫_N', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 41, name: '女巫_O', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 44, name: '女巫_P', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 47, name: '女巫_Q', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 50, name: '女巫_R', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 53, name: '女巫_S', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 56, name: '女巫_T', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 59, name: '女巫_U', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 62, name: '女巫_V', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 65, name: '女巫_W', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 68, name: '女巫_X', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 71, name: '女巫_Y', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' },
  { level: 74, name: '女巫_Z', reward: 'card_upgrade_letter',    rate: 0.3, has_reward: true, reward_desc: '有概率获得一张: 字母升级' }
