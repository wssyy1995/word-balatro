...
const SHOP_POOL = {
  witch: [
    ...
    {name:'双子合影', type:'witch', scope:'whole_word', trigger:'double_same', operation:'multi_adds_value', value:5, cost:12, min_level:20, desc:'相邻重复字母，倍率+5'},
    ...
    {name:'回到过去', type:'witch', scope:'whole_word', trigger:'end_ed', operation:'multi_adds_value', value:4, cost:12, min_level:10, desc:'打出的单词如果末尾加上\'ed\'也是合法单词,则倍率+4'},
    {name:'复制魔法', type:'witch', scope:'whole_word', trigger:'end_s', operation:'multi_adds_value', value:3, cost:14, min_level:15, desc:'打出的单词如果末尾加上\'s\'也是合法单词,则倍率+3'},
    ...
    {name:'混沌法球', type:'witch', scope:'whole_word', trigger:'chaos_orb', value:1, cost:12, min_level:1, desc:'每次出牌，单词倍率随机+[0.5~1.5]'}
  ],
  crystal: [
