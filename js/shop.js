...
const SHOP_POOL = {
  witch: [
    ...
    {name:'首尾呼应', type:'witch', scope:'whole_word', trigger:'firstend_same', operation:'multi_adds_value', value:6, cost:6, desc:'单词首尾字母相同，倍率+6'},
    ...
    {name:'回到过去', type:'witch', scope:'whole_word', trigger:'end_ed', operation:'multi_adds_value', value:6, cost:6, desc:'打出的单词如果末尾加上\'ed\'也是合法单词,则倍率+6'},
    {name:'复制魔法', type:'witch', scope:'whole_word', trigger:'end_s', operation:'multi_adds_value', value:5, cost:6, desc:'打出的单词如果末尾加上\'s\'也是合法单词,则倍率+5'}
  ],
  crystal: [
