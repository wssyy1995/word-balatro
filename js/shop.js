...
const SHOP_POOL = {
  witch: [
    ...
    {name:'勇敢试错', type:'witch', scope:'whole_word', trigger:'illegal_boost', value:0, cost:10, desc:'每次打出非法单词,本牌倍率+1；若装备了\'容错咒文\'，本牌无效'},
    {name:'以小博大', type:'witch', scope:'whole_word', trigger:'last_chance', value:10, cost:8, desc:'出牌<=3个字母,20%概率倍率+8'},
    {name:'双子合影', type:'witch', scope:'whole_word', trigger:'double_same', operation:'multi_adds_value', value:5, cost:8, desc:'相邻重复字母，倍率+5'},
    {name:'首尾呼应', type:'witch', scope:'whole_word', trigger:'firstend_same', operation:'multi_adds_value', value:6, cost:8, desc:'单词首尾字母相同，倍率+6'},
