...
const SHOP_POOL = {
  witch: [
    ...
    {name:'五字母连击', type:'witch', scope:'whole_word', trigger:'length_5', value:1.5, cost:7, desc:'单词字母>=5时，倍率×1.5'},
    {name:'六字母连击', type:'witch', scope:'whole_word', trigger:'length_6', value:2, cost:8, desc:'单词字母>=6时，倍率×2'},
    {name:'珍稀之力', type:'witch', scope:'whole_word', trigger:'has_face', operation:'multi_adds_value', value:5, cost:6, desc:'单词字母含J/Q/X/Y/Z时，倍率+5'},
    ...
    {name:'勇敢试错', type:'witch', scope:'whole_word', trigger:'illegal_boost', value:0, cost:5, desc:'每次打出非法单词,本牌倍率+1；若装备了\'容错咒文\'，本牌无效'},
    {name:'以小博大', type:'witch', scope:'whole_word', trigger:'last_chance', value:10, cost:8, desc:'出牌少于4个字母,20%概率倍率+8'},
    {name:'双子合影', type:'witch', scope:'whole_word', trigger:'double_same', operation:'multi_adds_value', value:5, cost:5, desc:'相邻重复字母，倍率+5'},
    {name:'首尾呼应', type:'witch', scope:'whole_word', trigger:'firstend_same', operation:'multi_adds_value', value:6, cost:6, desc:'单词首尾字母相同，倍率+8'},
    ...
    {name:'回到过去', type:'witch', scope:'whole_word', trigger:'end_ed', operation:'multi_adds_value', value:6, cost:6, desc:'打出的单词如果末尾加上\'ed\'也是合法单词,则倍率+5'},
    {name:'复制魔法', type:'witch', scope:'whole_word', trigger:'end_s', operation:'multi_adds_value', value:5, cost:6, desc:'打出的单词如果末尾加上\'s\'也是合法单词,则倍率+4'}
  ],
  crystal: [
