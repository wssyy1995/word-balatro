...
class CloudStorageManager {
  constructor(env) {
    ...
    this.defaultBgIconFileMap = {
      ...
      'shop_card_bar_witch': c('/bg_icon/shop_card_bar_witch5.png'),
      'shop_card_bar_crystal': c('/bg_icon/shop_card_bar_crystal5.png'),
      'shop_card_bar_potion': c('/bg_icon/shop_card_bar_potion5.png'),
