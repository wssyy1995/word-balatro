...
class StorageManager {
  ...
  _doSaveProgress() {
    ...
    const progress = {
      ...
      // 对战模式状态
      battleMode: game.battleMode || false,
      battleDifficulty: game.battleDifficulty || 'easy',
      battleRound: game.battleRound || 1,
      battleTotalRounds: game.battleTotalRounds || 10,
      battlePlayerScore: game.battlePlayerScore || 0,
      battleBotScore: game.battleBotScore || 0,
      battlePlayerRoundScores: game.battlePlayerRoundScores || [],
      battleBotRoundScores: game.battleBotRoundScores || [],
      battlePhase: game.battlePhase || 'selecting',
      battleBotWord: game.battleBotWord || null,
      battleBotCards: game.battleBotCards || null,
      battleBotThinking: game.battleBotThinking || false,
      battleBotReady: game.battleBotReady || false,
      battleBotThinkingStartTime: game.battleBotThinkingStartTime || null,
      battleSelected: game.battleSelected || [],
      battlePendingCheck: game.battlePendingCheck || null,
      battlePlayerWord: game.battlePlayerWord || null,
      battlePlayerCards: game.battlePlayerCards || null,
      battlePlayerRoundScore: game.battlePlayerRoundScore || 0,
      battleBotRoundScore: game.battleBotRoundScore || 0,
      battleBotWordLength: game.battleBotWordLength || 0,
      _battleDeck: game._battleDeck || [],
      _battlePlayedWords: game._battlePlayedWords ? [...game._battlePlayedWords] : [],
      _pendingBotChoice: game._pendingBotChoice || null,
      _battleBotThinkDuration: game._battleBotThinkDuration || null,
      _battleRevealStartTime: game._battleRevealStartTime || null,
      _battleAnimTimeline: game._battleAnimTimeline || null,
      _battleFlyingScores: game._battleFlyingScores || [],
      _battleBotReadyAnimStart: game._battleBotReadyAnimStart || null,
      timestamp: Date.now(),
      version: 1
    };
